...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAudioUI",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAudioUI-1.0.0-beta+20230309171424.xcframework.zip",
			checksum: "dbcdada255fb5e8d740cfe1d25038e4ebfdc17a56fe0b8dafe63aa44d2138e4f"
		)
	]
)