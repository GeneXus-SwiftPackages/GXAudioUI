...
let package = Package(
	...
	dependencies: [
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXAudioBL.git", exact: "2.2.0-beta.24"),
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAudioUI",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAudioUI-2.2.0-beta.24.xcframework.zip",
			checksum: "850ada071c73639e1ea3b3385f7053065746fb18360987c8b759d5ddb6ca8299"
		)
	]
)