...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAudioUI",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAudioUI-1.0.0-beta+20230509173316.xcframework.zip",
			checksum: "07c3618d56fa2330aa91bd41684b76becf44c240c9d2a39418b64bd918d74c0e"
		)
	]
)