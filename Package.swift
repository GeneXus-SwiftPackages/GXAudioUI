...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAudioUI",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAudioUI-1.0.0-beta+20230524184838.xcframework.zip",
			checksum: "848bb80b5e49f4b7e12a1f82dfa317ba037a121a27a2aaf1ea29e7e5441cbc6a"
		)
	]
)